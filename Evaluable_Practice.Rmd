...
There are 68 outliers, as there enough data records, we will eliminate them.
...
There are 125/106??????????? outliers, as there enough data records, we will eliminate them.
...
There are 7 outliers, as there enough data records, we will eliminate them.
...
# Histogram and density plots
# Remember that package 'ggplot2' is required
p1<-ggplot(data_train,aes(x=ExterQual))+geom_density()+
  labs(title = "Density of ExterQual",x="ExterQual",y="Values")

p2<-ggplot(data_train,aes(x=OverallQual))+geom_histogram()+
  labs(title = "Histogram of ExterQual",x="ExterQual",y="Values")
