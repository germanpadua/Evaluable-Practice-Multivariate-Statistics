...
# Histogram representation of the column OverallQual
par(mfcol = c(1, 1))
...
```{r warning=FALSE, message=FALSE}
# Representation of normal quantiles for the column OverallQual
par(mfrow = c(1, 1))
...
# Print the row corresponding to OverallQual
print(subset(result, variable == "OverallQual"))
...
# Histogram representation of the column OverallCond
par(mfcol = c(1, 1))
...
```{r warning=FALSE, message=FALSE}
# Representation of normal quantiles for the column OverallCond
par(mfrow = c(1, 1))
...
# Print the row corresponding to OverallCond
print(subset(result, variable == "OverallCond"))
...
# Histogram representation of the column YearBuilt
par(mfcol = c(1, 1))
...
```{r warning=FALSE, message=FALSE}
# Representation of normal quantiles for the column YearBuilt
par(mfrow = c(1, 1))
...
# Histogram representation of the column YrSold
par(mfcol = c(1, 1))
...
```{r warning=FALSE, message=FALSE}
# Representation of normal quantiles for the column YrSold
par(mfrow = c(1, 1))
...
# Print the row corresponding to YrSold
print(subset(result, variable == "YrSold"))
...
na_counts <- sum(is.na(data_train$SalePrice))
...
p1 <- ggplot(data_train, aes(x = SalePrice)) +
  geom_boxplot(outlier.colour = "red", outlier.shape = 1, outlier.size = 2) +
  coord_flip() +
  labs(title = "Boxplot of SalePrice", x = "Values", y = "")

ggarrange(p1, nrow=1, common.legend = FALSE)

# Count outliers
outliers <- boxplot.stats(data_train$SalePrice)$out

# Display the count of outliers
cat("Number of outliers:", length(outliers), "\n")

# Identify rows with outliers
outlier_rows <- which(data_train$SalePrice %in% outliers)
...
There are 38 outliers, as there enough data records, we will eliminate them.
...
# Histogram representation of the column SalePrice
par(mfcol = c(1, 1))
...
```{r warning=FALSE, message=FALSE}
# Representation of normal quantiles for the column SalePrice
par(mfrow = c(1, 1))
...
# Print the row corresponding to SalePrice
print(subset(result, variable == "SalePrice"))
